...
public class MyDbClassLessons extends SQLiteAssetHelper {
    private static final String DATABASE_NAME = "wordlists.db";
    private static final int DATABASE_VERSION = 1;

    Context context;
    public MyDbClassLessons(Context context) {
    ...
    public ArrayList<DbModelClass> getAllData(){
        try{
            ...
            if(objSqLiteDatabase!=null){
                Cursor objCursor = objSqLiteDatabase.rawQuery("SELECT *FROM lessons",null);
