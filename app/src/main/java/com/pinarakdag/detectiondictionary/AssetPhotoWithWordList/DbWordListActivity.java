...
public class DbWordListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_db_word_list);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.lessons){
            Intent intent = new Intent(DbWordListActivity.this, DbWordList2Activity.class);
