...
public class QuizActivity extends AppCompatActivity {
    ...
    private void showNextQuestion() {
        ...
        if(questionCounter<questionCountTotal){
            ...
            int ImageId=this.getResources().getIdentifier(currentQuestion.getQuestion().toLowerCase(),"drawable",getPackageName());
            imageViewQuestion.setBackgroundResource(ImageId);
