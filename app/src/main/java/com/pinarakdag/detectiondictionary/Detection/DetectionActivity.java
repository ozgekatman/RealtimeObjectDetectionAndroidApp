package com.pinarakdag.detectiondictionary.Detection;
        ...
        if (startYolo == true) {
            ...
            if (ArrayLength>=1) {
                ...
                for (int i = 0; i < ind.length; ++i) {
                    ...
                    Imgproc.putText(frame,cocoNames.get(idGuy) + " " + intConf + "%",box.tl(),Core.FONT_HERSHEY_SIMPLEX, 2, new Scalar(12, 128, 129),5);



                    Imgproc.rectangle(frame, box.tl(), box.br(), new Scalar(255, 145, 164), 10);
