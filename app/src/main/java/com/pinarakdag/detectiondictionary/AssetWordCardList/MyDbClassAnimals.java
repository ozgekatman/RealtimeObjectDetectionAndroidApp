...
public class MyDbClassAnimals extends SQLiteAssetHelper {
    private static final String DATABASE_NAME = "wordcards.db";
    private static final int DATABASE_VERSION = 1;

    Context context;
    public MyDbClassAnimals(Context context) {
    ...
    public ArrayList<DbModelClass> getAllData(){
        try{
            ...
            if(objSqLiteDatabase!=null){
                Cursor objCursor = objSqLiteDatabase.rawQuery("SELECT *FROM animals",null);
