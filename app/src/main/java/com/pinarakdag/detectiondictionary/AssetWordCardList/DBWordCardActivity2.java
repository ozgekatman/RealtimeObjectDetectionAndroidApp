...
public class DBWordCardActivity2 extends AppCompatActivity {
    MyDbClassAnimals objMyDbClass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dbword_card2);
        objMyDbClass = new MyDbClassAnimals(this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.foodDrinks){
            Intent intent = new Intent(DBWordCardActivity2.this, DBWordCardActivity.class);
