...
public class MyDbClassAdj extends SQLiteAssetHelper {
    private static final String DATABASE_NAME = "list.db";
    private static final int DATABASE_VERSION = 1;

    Context context;
    public MyDbClassAdj(Context context) {
    ...
    public ArrayList<DbModelClass> getAllData(){
        try{
            ...
            if(objSqLiteDatabase!=null){
                Cursor objCursor = objSqLiteDatabase.rawQuery("SELECT *FROM adjective",null);
