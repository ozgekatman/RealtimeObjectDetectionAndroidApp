...
public class DbList2Activity extends AppCompatActivity {
    MyDbClassAdj objMyDbClass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_db_list2);
        objMyDbClass = new MyDbClassAdj(this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.noun){
            Intent intent = new Intent(DbList2Activity.this, DbListActivity.class);
            startActivity(intent);
            finish();
        }
        else if(id == R.id.verb){
            Intent intent = new Intent(DbList2Activity.this, DbList3Activity.class);
            startActivity(intent);
            finish();
        }
