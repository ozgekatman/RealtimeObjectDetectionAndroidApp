...
public class DbList3Activity extends AppCompatActivity {
    MyDbClassVerb objMyDbClass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_db_list3);
        objMyDbClass = new MyDbClassVerb(this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.noun){
            Intent intent = new Intent(DbList3Activity.this, DbListActivity.class);
            startActivity(intent);
            finish();
        }
        else if(id == R.id.adjective){
            Intent intent = new Intent(DbList3Activity.this, DbList2Activity.class);
            startActivity(intent);
            finish();
        }
