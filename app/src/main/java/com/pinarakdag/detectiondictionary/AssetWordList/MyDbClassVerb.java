...
public class MyDbClassVerb extends SQLiteAssetHelper {
    private static final String DATABASE_NAME = "list.db";
    private static final int DATABASE_VERSION = 1;

    Context context;
    public MyDbClassVerb(Context context) {
    ...
    public ArrayList<DbModelClass> getAllData(){
        try{
            ...
            if(objSqLiteDatabase!=null){
                Cursor objCursor = objSqLiteDatabase.rawQuery("SELECT *FROM verb",null);
